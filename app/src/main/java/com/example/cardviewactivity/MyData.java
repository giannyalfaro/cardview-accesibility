...
public class MyData {
    ...
    static Integer[] drawableArray = {R.drawable.ic_basic_group_ui_svgrepo_com, R.drawable.ic_basic_group_ui_svgrepo_com,
            R.drawable.ic_basic_group_ui_svgrepo_com, R.drawable.ic_basic_group_ui_svgrepo_com,
            R.drawable.ic_basic_group_ui_svgrepo_com, R.drawable.ic_basic_group_ui_svgrepo_com,
            R.drawable.ic_basic_group_ui_svgrepo_com, R.drawable.ic_basic_group_ui_svgrepo_com,
            R.drawable.ic_basic_group_ui_svgrepo_com, R.drawable.ic_basic_group_ui_svgrepo_com,
            R.drawable.ic_basic_group_ui_svgrepo_com, R.drawable.ic_basic_group_ui_svgrepo_com};
